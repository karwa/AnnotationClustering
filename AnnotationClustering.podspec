#
#  Be sure to run `pod spec lint AnnotationClustering.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.author             = { "Karl" => "email@address.com" }
  # Or just: s.author    = "Karl"
  # s.authors            = { "Karl" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Karl"
  ...
  s.source       = { :git => "https://github.com/karwa/AnnotationClustering.git", :tag => "#{s.version}" }
